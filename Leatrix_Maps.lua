		...
		do
			...
			local PinData = {
				...
				--[[Arathi Highlands]] [1417] = {
					...
					{"Arrow", 45.4, 88.9, L["Wetlands"] .. " " .. L["(via Thandol Span)"], nil, arTex, nil, nil, nil, nil, nil, 3.2, 1437},
				...
				--[[Western Plaguelands]] [1422] = {
					...
					{"Arrow", 28.6, 57.5, L["Tirisfal Glades"] .. " " .. L["(via The Balwark)"], nil, arTex, nil, nil, nil, nil, nil, 1.6, 1420},
				...
				--[[Dun Morogh]] [1426] = {
					...
					{"Arrow", 84.3, 31.1, L["Loch Modan"] .. " " .. L["(via North Gate Pass)"], nil, arTex, nil, nil, nil, nil, nil, 0, 1432},
					{"Arrow", 82.2, 53.5, L["Loch Modan"] .. " " .. L["(via South Gate Pass)"], nil, arTex, nil, nil, nil, nil, nil, 5, 1432},
					{"Arrow", 30.5, 34.5, L["Wetlands"] .. " " .. L["(requires death)"], nil, arTex, nil, nil, nil, nil, nil, 6.2, 1437},
				...
				--[[Searing Gorge]] [1427] = {
					...
					{"Arrow", 78.5, 17.4, L["Loch Modan"] .. " " .. L["(requires key)"], nil, arTex, nil, nil, nil, nil, nil, 5.4, 1432},
					{"Arrow", 33.6, 79.0, L["Burning Steppes"] .. " " .. L["(via Blackrock Mountain)"], nil, arTex, nil, nil, nil, nil, nil, 3, 1428},
				...
				--[[Burning Steppes]] [1428] = {
					...
					{"Arrow", 31.9, 50.4, L["Searing Gorge"] .. " " .. L["(via Blackrock Mountain)"], nil, arTex, nil, nil, nil, nil, nil, 1.5, 1427},
				},
				--[[Elwynn Forest]] [1429] = {
				...
				--[[Loch Modan]] [1432] = {
					...
					{"Arrow", 18.4, 83.0, L["Searing Gorge"] .. " " .. L["(requires key)"], nil, arTex, nil, nil, nil, nil, nil, 2.6, 1427},
					{"Arrow", 20.4, 17.4, L["Dun Morogh"] .. " " .. L["(via North Gate Pass)"], nil, arTex, nil, nil, nil, nil, nil, 1.1, 1426},
					{"Arrow", 46.8, 76.9, L["Badlands"], nil, arTex, nil, nil, nil, nil, nil, 3.2, 1418},
					{"Arrow", 21.5, 66.2, L["Dun Morogh"] .. " " .. L["(via South Gate Pass)"], nil, arTex, nil, nil, nil, nil, nil, 0.5, 1426},
				...
				--[[Wetlands]] [1437] = {
					...
					{"Arrow", 51.3, 10.3, L["Arathi Highlands"] .. " " .. L["(via Thandol Span)"], nil, arTex, nil, nil, nil, nil, nil, 0, 1417},
					{"Arrow", 56.0, 70.3, L["Loch Modan"] .. " " .. L["(via Dul Algaz)"], nil, arTex, nil, nil, nil, nil, nil, 1.8, 1432},
				},
				--[[Stormwind City]] [1453] = {
				...
				--[[The Barrens]] [1413] = {
					...
					{"Arrow", 44.1, 91.5, L["Thousand Needles"] .. " " .. L["(via The Great Lift)"], nil, arTex, nil, nil, nil, nil, nil, 3, 1441},
				...
				--[[Ashenvale]] [1440] = {
					...
					{"Arrow", 42.3, 71.1, L["Stonetalon Mountains"] .. " " .. L["(via The Talondeep Path)"], nil, arTex, nil, nil, nil, nil, nil, 2.7, 1442},
				...
				--[[Stonetalon Mountains]] [1442] = {
					...
					{"Arrow", 78.2, 42.8, L["Ashenvale"] .. " " .. L["(via The Talondeep Path)"], nil, arTex, nil, nil, nil, nil, nil, 6.1, 1440},
				},
				--[[Desolace]] [1443] = {
				...
				--[[Felwood]] [1448] = {
					...
					{"Arrow", 65.0, 8.3, L["Winterspring"] .. " " .. L["(via Timbermaw Hold)"], nil, arTex, nil, nil, nil, nil, nil, 5.9, 1452},
				...
				--[[Moonglade]] [1450] =  {
					...
					{"Arrow", 35.7, 72.4, L["Felwood"] .. ", " .. L["Winterspring"] .. " " .. L["(via Timbermaw Hold)"], nil, arTex, nil, nil, nil, nil, nil, 3, 1448},
				},
				--[[Silithus]] [1451] = {
				...
				--[[Winterspring]] [1452] = {
					...
					{"Arrow", 27.9, 34.5, L["Felwood"] .. " " .. L["(via Timbermaw Hold)"], nil, arTex, nil, nil, nil, nil, nil, 0.7, 1448},
				},
				--[[Orgrimmar]] [1454] =  {
						...
						for i = 1, count do
							...
							then
								...
								elseif pinInfo[1] == "Arrow" then
									...
									pin:SetScript("OnMouseUp", function() WorldMapFrame:SetMapID(pinInfo[13]) end)
								end
							end
